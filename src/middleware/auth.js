...
module.exports = {
  ...
  verificarAdminSopCom: verificarRol(['administrador', 'soporte', 'aplicaciones', 'comercial', 'Dir. Comercial']),
  verificarAdminCalCot: verificarRol(['administrador', 'cotizaciones', 'ventas', 'ingresos', 'calidad', 'aplicaciones']),
  verificarAdminSopComCot: verificarRol(['administrador', 'soporte', 'aplicaciones', 'comercial', 'Dir. Comercial', 'cotizaciones', 'ventas', 'ingresos']),
  ...
  verificarUsuario: verificarRol(['administrador', 'cotizaciones', 'ventas', 'ingresos', 'calidad', 'soporte', 'aplicaciones', 'comercial', 'Dir. Comercial', 'bodega']),
  verificarUsuarioLum: verificarRol(['administrador', 'cotizaciones', 'ventas', 'ingresos', 'calidad', 'soporte', 'aplicaciones', 'comercial', 'Dir. Comercial', 'bodega', 'lumira']),
};